...
{
    public partial class THEBOX : Form
    {
        public THEBOX()
        {
            InitializeComponent();
        ...
        private void THEBOX_Load(object sender, EventArgs e)
        {
            ...
            thebox.Location = new Point(35, 70);
            thebox.Size = new Size(200, 300);
            thebox.SizeMode = PictureBoxSizeMode.StretchImage;
            this.Controls.Add(thebox);

            Label lblthebox = new Label();
            lblthebox.Text = "THE BOX";
            lblthebox.Location = new Point(103, 50);
            lblthebox.Size = new Size(100, 40);

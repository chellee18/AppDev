...
{
    public partial class CIVILWAR : Form
    {
        public CIVILWAR()
        {
            InitializeComponent();
        ...
        private void CIVILWAR_Load(object sender, EventArgs e)
        {
            ...
            civilwar.Location = new Point(35, 70);
            civilwar.Size = new Size(200, 300);
            ...
            lblcivil.Location = new Point(103, 50);
